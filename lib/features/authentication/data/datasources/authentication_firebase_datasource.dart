...
class AuthenticationFirebaseDataSourceImpl implements AuthenticationFirebaseDataSource {
  AuthenticationFirebaseDataSourceImpl({firebase_auth.FirebaseAuth? firebaseAuth})
